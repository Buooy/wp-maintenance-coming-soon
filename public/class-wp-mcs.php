...
class Wp_Mcs {
	...
	private function __construct() {
		...
		add_action( 'template_redirect', array( $this, 'display_mcs' ) ); 
	...
	/**
	 *	Displays the Maintenance Mode or Coming Soon
	 *
	 */
	public function display_mcs(){
		...
		// Check if the user is logged in and if he is a member of the blog
		if( is_user_logged_in() ){
			// Check when multisite, if the member is a part of the blog
			if( function_exists( 'is_multisite' ) && is_multisite() && is_user_member_of_blog() ){
				$is_authorized = true;
			}
			// Check when not multisite
			else if( function_exists( 'is_multisite' ) && !is_multisite() ){
				$is_authorized = true;
			}
		}
